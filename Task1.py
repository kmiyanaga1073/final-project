...
ax.plot(asset_grid, policy_t1[0, :], label='低生産性', color='blue', linestyle='-')
ax.plot(asset_grid, policy_t1[1, :], label='中生産性', color='green', linestyle='--')
ax.plot(asset_grid, policy_t1[2, :], label='高生産性', color='red', linestyle='-.')
ax.plot(asset_grid, asset_grid, 'k--', label='45度線 (貯蓄=資産)')
ax.set_title('若年期貯蓄政策関数 (年金なし)', fontsize=16)
ax.set_xlabel('若年期初期の利子を除く資産 (a)', fontsize=12)
ax.set_ylabel('若年期の貯蓄 (a\')', fontsize=12)
